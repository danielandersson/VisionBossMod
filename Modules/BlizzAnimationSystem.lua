--[[
	Local copy of Blizzard Animation system from WoW 3.3
	to avoid taint of veichle UI
	Changed: SetUpAnimation to VBM_SetUpAnimation (for a local copy)
...
function VBM_SetUpAnimation(frame, animTable, postFunc, reverse)
